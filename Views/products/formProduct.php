...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="my-3">
        ...
        <input type="text" name="title" id="title" class="form-control" placeholder="Nom de votre produit">
    </div>
    <div class="my-3 form-group">
        <label for="price" class="form-label">Prix du produit</label>
        <div class="input-group">
            <input type="number" step="0.01" name="price" id="price" class="form-control" placeholder="Prix souhaité">
            <span class="input-group-text">€</span>
        </div>
    </div>
    <div class="form-group my-3">
        <label for="description" class="form-label mt-4">Description</label>
        <textarea class="form-control" name="description" id="description" rows="3" placeholder="Plus votre description est pertinente, plus vous aurez de chance de vendre votre produit"></textarea>
    </div>
